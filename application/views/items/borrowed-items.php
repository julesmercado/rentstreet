                    ...
                    <div class="row container-mp">
                        ...
                        <div class="col-md-9">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body" ng-init="getBorrowedFromOther(<?php echo $user_id; ?>)">
                                    <div class="container-bi">
                                        <div class="row ">
                                       

                                            <div class="row" ng-repeat="data in borrowOther | filter: query">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="row item-detail">
                                                   <p><a href="<?php echo base_url('view-other-profile'); ?>/{{data.owners_id}}">View More Information</a></p>
                                                </div>

    ...
    <div class="content-section-a">
        <div class="container">
            <div class="row marin-top-vop">
                ...
                <div class="col-md-8">
                    <div class="row" >
                        <div class="col-dashboard panel panel-default col-dashboard-cuz" ng-init="getRateAfterReturnIfo(<?php echo $rentedId; ?>)">
                            <div class="panel-heading p-heading-dashborad-ma">
                                RATE CLIENT AND ITEMS
                            </div>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="row">
                                        <div class="col-md-5">
                                           <img class="img-circle rate-after-img"  ng-src="{{rateAfterReturn[0].img_path}}">
                                        </div>
                                    </div>

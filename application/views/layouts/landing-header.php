...
<head>
    ...
    <title>RentStreet.ph</title><!-- Bootstrap Core CSS -->
    <link href="<?php echo base_url('assets/css/bootstrap.min.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/css/app.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/css/landing-page.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/css/styles.css'); ?>" rel="stylesheet"><!-- Custom CSS -->
    <!-- Custom Fonts -->
...
<body ng-controller="myController" ng-init="getLandingInfo()">
                    ...
                    <div class="row container-mp">
                        ...
                        <div class="col-md-9">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body" ng-init="getMyAds(<?php echo $user_id; ?>)">
                                    <div class="container-bi">
                                        <div class="row">
                                            <div class="row row-margin-ma">
                                                <div class="col-md-12 ads-p">
                                                    <p>Managing your ads is now easier! You can
                                    now access the full list of your ads - edit
                                    or delete in just a few click.</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class=
                                                "row edit-delete-menu item-ma-margin link-ma">
                                                <a href="#"><span class="glyphicon glyphicon-edit"></span> Edit |</a>
                                                <a href="<?php echo base_url('items/deleteItem') ?>/{{data.id}}"> <span class="glyphicon glyphicon-trash"></span> Delete |</a>
                                                <a href="<?php echo base_url('view-details');?>/{{data.id}}"><span class="glyphicon glyphicon-plus"></span> More Ad Details</a>
                                                </div>
                                            </div>
